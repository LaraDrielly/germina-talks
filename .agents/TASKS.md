...
- [x] Criar estrutura base do monorepo (diretórios apps e packages)
  - Descrição: Criar diretórios `apps/web`, `packages/db`, `packages/shared`.
  - Prioridade: P0

- [x] Configurar Next.js 15 (App Router) em `apps/web`
  - Descrição: Inicializar projeto Next.js com TS e Tailwind CSS.
  - Prioridade: P0


- [x] Configurar Prisma em `packages/db`
  - Descrição: Inicializar Prisma, configurar conexão Postgres.
  - Prioridade: P0

- [x] Configurar estrutura de pacotes compartilhados em `packages/shared`
  - Descrição: Definir tipos e esquemas Zod base.
  - Prioridade: P0

- [x] Configurar Docker Compose para ambiente de desenvolvimento
